...
public class DBSetupUtils {
    ...
    public static final Operation INSERT_CUSTOMERS;
    public static final Operation INSERT_ADRESSES;
	...
	static {
		...
		INSERT_CUSTOMERS = insertCustomers;
		...
		INSERT_ADRESSES = insertAddresses;
